...
<div id="wrapper">
{if isset($MENUBAR)}
        <nav class="navbar navbar-expand-lg navbar-main {$theme_config->navbar_main_bg} {if $theme_config->page_header == 'fancy'}navbar-dark {else}{$theme_config->navbar_main_style}{/if}">
